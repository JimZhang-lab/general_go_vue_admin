/*
 * @Author: JimZhang
 * @Date: 2025-07-24 11:50:48
 * @LastEditors: 很拉风的James
 * @LastEditTime: 2025-07-25 01:03:16
 * @FilePath: /server/common/result/code.go
 * @Description:
 *
 */
package result
...
// 外部调用
func (m *Codes) GetMessage(code uint) string {
	message, ok := m.Message[code]
	if ok {
		return message
	}
	return "未知错误"
