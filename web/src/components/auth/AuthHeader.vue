 ...
 * @FilePath: /web/src/components/auth/AuthHeader.vue
 * @Description: 
 * 
 */
<template>
  ...
  >
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      <!-- 左侧区域 -->
      <div
        class="flex items-center justify-between w-full px-3 py-3 border-b border-gray-200 dark:border-gray-800 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4"
        style="gap: 0.5rem;"
      >
        <!-- 侧边栏切换按钮 -->
        <button
      ...
      >
        ...
        <div class="flex items-center" style="gap: 0.5rem;">
          ...
          <div class="flex items-center" style="gap: 0.25rem;">
            ...
            <router-link
              to="/auth/admin"
              class="flex items-center justify-center w-9 h-9 text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-300"
              title="添加管理员"
            >
